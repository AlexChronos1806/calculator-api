...
public class MultiplicationCalculator implements Calculable, Operable {

    private final double x;
    private final double y;

    public MultiplicationCalculator(double x, double y) {
        this.x = x;
        this.y = y;
    }
    ...
    public OperationOptions getType() {
        return OperationOptions.MULTIPLICATION;
    }
}
